<?php
	...
	class Ventas_model extends Model {
		...
		public function updatePreevento($id, $fechaEvento, $vendedor, $tipoCliente, $contacto, $estadoCiudad,
															$empresa, $tipoEmpresa, $telContacto, $telContacto2, $email, $email2,
															$tipoEvento, $lugar, $calleNumero, $colonia, $municipio, $estado, $tel,
															$entreCalles, $codigoPostal, $totalPersonas, $adultos, $ninos, $horario,
															$hrServicio, $fechaCita, $hrCita, $metodoCita, $hrExtra, $costoHr){

			$data = array('fechaEvento' => $fechaEvento, 'vendedor' => $vendedor, 'tipoCliente' => $tipoCliente,
										'contacto' => $contacto, 'estadoCiudad' => $estadoCiudad, 'empresa' => $empresa,
										'tipoEmpresa' => $tipoEmpresa, 'telContacto' => $telContacto, 'telContacto2' => $telContacto2,
										'email' => $email, 'email2' => $email2, 'tipoEvento' => $tipoEvento, 'lugar' => $lugar,
										'calleNumero' => $calleNumero, 'colonia' => $colonia, 'municipio' => $municipio, 'estado' => $estado,
										'tel' => $tel, 'entreCalles' => $entreCalles, 'codigoPostal' => $codigoPostal,
										'totalPersonas' => $totalPersonas, 'adultos' => $adultos, 'ninos' => $ninos, 'horario' => $horario,
										'hrServicio' => $hrServicio, 'fechaCita' => $fechaCita, 'hrCita' => $hrCita, 'metodoCita' => $metodoCita,
										'hrExtra' => $hrExtra, 'costoHr' => $costoHr);

			return $this->db->update($data, "preevento", "idPreevento = '$id'");
		}


		public function deleteCoti($id)
		{
			return $this->db->delete("cotizado", "idPreevento = '$id'");
		}
